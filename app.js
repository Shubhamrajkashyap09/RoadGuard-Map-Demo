...
// Function to add a red zone around a specific location
function addRedZone(coordinates) {
  ...
  alertSymbolFeature.setStyle(
    new ol.style.Style({
      image: new ol.style.Icon({
        ...
        anchorYUnits: 'fraction',
        opacity: 0.75,
        src: 'C:/Users/Satvik/Downloads/1612/custom-alert-symbol.jpg', // Path to your custom alert symbol image
...
var locationCoordinates = [
  ol.proj.fromLonLat([77.704211 - 0.002, 13.242482 - 0.002]),
  ol.proj.fromLonLat([77.704211 + 0.002, 13.242482 - 0.002]),
  ol.proj.fromLonLat([77.704211 + 0.002, 13.242482 + 0.002]),
  ol.proj.fromLonLat([77.704211 - 0.002, 13.242482 + 0.002]),
  ol.proj.fromLonLat([77.704211 - 0.002, 13.242482 - 0.002]), // Repeat the first coordinate to close the polygon
];

// Call the functions to add the red zone and car icon
addRedZone(locationCoordinates);
